...
\pitch{3} Continue up the dihedral. To the right is a 2" crack that forms the
...
\pitch{3} Head diagonally toward a left-facing dihedral. 5.6
...
\pitch{5} Climb up and left through blocky terrain along the obvious weakness, the
...
\variation{1} Vogel and Gaines consider this to be the standard route, but others disagree.
