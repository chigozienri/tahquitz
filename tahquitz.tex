...
\variation{1} Climb up from the middle of the ledge, surmounting all the steps
...
tree, head 10' up a 5.4 slab to an orange bolt. (The slab is steeper
...
\warn{I've only done this climb twice, so some of this may be inaccurate.
The first belay is shown in what I think the location Gaines gives, but
I think we belayed farther to the right, which may have been a more difficult
route.}

Sustained climbing at the grade. This is an old-school 5.6, and in
many climbing areas it would probably be rated more like 5.8. The
bottom pitches are shared with Jensen's Jaunt, the final ones with
Coffin Nail and On the Road.  Pro to 4".  FA Carl Jensen, Jim Smith,
and Don McDonald, 1938. Chuck Wilts's guidebook says that the route was first climbed because
someone fell off of the Traitorhorn route and decided to go around rather
than trying again to get up Traitorhorn.
...
(not shown on the topo) at about the same height as the first belay.
One of these walls is to the left (first belay of Coffin Nail) and one
to the right (start of Turbo Flange, at the bottom of the red-brown
stain).  From the trail, it is easy to identify the red-brown stain,
the kidney-shaped flake, and the imposing overhangs of Traitorhorn,
the latter seeming more prominent and higher up than they actually
are.  Scramble up to a a start at a wooded ledge just above the trail.

\pitch{1} Climb easy terrain to a belay near several trees. 5.0, 20 m

\pitch{2} Head up with the goal of getting on top of the right-facing
...
\pitch{3} Climb a jam crack that leads up and left. The first moves
...
left corner of the Traitorhorn overhangs.  Hanging belay on a spacious
slope. 
...
going around to the right. Climb class 4 blocks, then traverse 5.6 slab to a
low-angle hand-and-fist crack. (It's possible that there is an easier way to
do this, since Gaines implies that the whole pitch is 5.2.)
Climb the 5.2 crack (or walk up the slab). 55 m.

\variation{1} Climb the dihedral. I haven't tried this variation. Gaines calls it 5.7.
...
\pitch{3} Traverse to the right side of the ledge and begin climbing a
