...
\pitch{4} Climb up from the middle of the ledge. (Linking P4 and P5 will
...
\pitch{4} Climb 5.3 face up toward the roof.
...
\pitch{6} Climb easy 5th class terrain to a big, comfy belay at a squat pine tree.

\pitch{7} 4th class to the top of the rock.
...
This is the longest route on the rock. On the first two pitches,
rock quality is not as good as we normally expect at Tahquitz.
Some of the belay ledges
are littered with baseball- to cantaloupe-sized rocks.
I have inadvertently kicked down rocks several times on this route,
and have been hit in the face with a thumb-sized rock.
I would avoid climbing this route below
another party.
...
North Buttress route. Climb up and left through blocky terrain along the obvious weakness, the
...
\variation{4} Wilts and Vogel describe a supposedly easier traverse across a
``30' smooth face'' ``on small holds'' ``at the same level as the [`J' tree].''

\pitch{6} Escape the alcove by climbing up and left, then continue upward a little, 5.5.
Wait for an easy traverse to appear on the left. Head left and continue along a long
and nearly horizontal route, easy 5th class.
The traverse ends at a sandy area near the saddle above the northwest gully
descent route. Starting the traverse too early leads to more difficult (5.7) traversing
and downclimbing
into the gully at the top of the Larks. Once you're on the correct, easy traverse,
the easy climbing is found by avoiding the temptation to turn upward.

\variation{5} Vogel seems to describe a 5.3 exit above and to the right of the tree alcove.
