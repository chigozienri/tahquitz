...
routefinding.  The few harder moves are protectable. This climb
ends near the summit, so it's long, and climbing parties commonly
take longer than expected to get up it and end up hiking out in
the dark. Pro to 2".
...
Many of the belay ledges have baseball-sized loosr rocks on them, so
...
is preferable because it gets you to belay 4 with a 60 m rope. $\sim 30$ m

\pitch{4} Continue up 5.0 climbing with less abundant protection.
A right-facing wall develops to the left. 
As you near an overhang, the climbing gets harder.
Continue to a hanging belay. The belay needs to be right near the
...
Up to a ledge below a huge gendarme. 5.0 climbing with scarce pro.
60 m
