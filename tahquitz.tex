...
continues around a corner.  This is easily protected with 0.3"-0.5"
cams. (Do not follow the ramp lower down.)  A few feet before a small
tree, head 10 vertical feet up a 5.5 slab to an orange bolt. (The slab is steeper
...
\pitch{1} Climb easy terrain to a belay near the rightmost of several trees. 5.0, 20 m
...
below the summit. Start from the left side of the Maiden Buttress, which can be
